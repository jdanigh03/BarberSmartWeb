...
const PaymentsPage = () => {
   const dummyPayments = [
    { id: 1, client: 'Juan Rodríguez', amount: 25.00, date: '2024-07-28', status: 'Realizado', method: 'Tarjeta' },
    { id: 2, client: 'Ana Gómez', amount: 30.00, date: '2024-07-29', status: 'Pendiente', method: 'E  fectivo' },
  ];
  return (
    <div>
